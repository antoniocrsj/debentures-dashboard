...
function extrairSerie(texto) {
  ...
  return {
    ...
    indexadorTeto: teto.indexador, spreadTeto: teto.spread, taxaTetoRaw: teto.raw,
    compBps,
  ...
  for (const msg of msgs) {
    ...
    for (const b of lista) {
      ...
      rows.push({
        ...
        IndexadorTeto: s.indexadorTeto, SpreadTetoPct: s.spreadTeto ?? '', TaxaTetoRaw: s.taxaTetoRaw,
